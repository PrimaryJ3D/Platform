...
const securityHeaders: Record<string, string> = {
  ...
  // X-Frame-Options omitted — using CSP frame-ancestors instead so the
  // Lovable editor preview can iframe the site. Production frame-ancestors
  // allows self + lovable.app/dev hosts only.
